      ...
      <div className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-[620px] h-[46px] px-2.5 rounded-lg border border-[#EAEAEA] bg-white text-sm font-normal leading-[150%] tracking-[0.5px] text-[#828282] focus:outline-none"
          />
        </div>
