...
interface ConfirmSendFeedbackProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

const ConfirmSendFeedback: React.FC<ConfirmSendFeedbackProps> = ({
  isOpen,
  onClose,
  onConfirm
}) => {
        ...
        <div className="flex flex-col items-center p-6 text-center">
          ...
          <div className="mb-6 text-center">
            <h2 className="text-[#CF0000] text-xl font-bold mb-2">
              Anda yakin ingin mengirim feedback?
            </h2>
            <p className="text-[#303030] text-sm">
              Pastikan feedback yang anda masukkan sudah sesuai.
            </p>
          </div>
...
export default ConfirmSendFeedback;