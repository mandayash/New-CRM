...
interface DeleteQRModalProps {
  ...
  onClose: () => void;
  onConfirm: () => void;
  count: number; // Jumlah QR yang akan dihapus
}

const DeleteQRModal = ({ isOpen, onClose, onConfirm, count }: DeleteQRModalProps) => {
  return (
          ...
          <div className="mb-6 text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <h2 className="text-[#CF0000] text-xl font-bold">
                Anda yakin ingin menghapus {count} data QR?
              </h2>
            </div>
            <p className="text-[#303030] text-sm">
              Jika Anda menghapus data QR, data akan terhapus secara permanen.
            </p>
          </div>
