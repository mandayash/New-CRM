...
interface SuccessSendArticleProps {
  isOpen: boolean;
  onClose: () => void;
}

const SuccessSendArticle: React.FC<SuccessSendArticleProps> = ({
  isOpen,
  onClose
}) => {
  return (
        ...
        <div className="flex flex-col items-center p-6 text-center">
          ...
          <div className="mb-6 text-center">
            ...
            <p className="text-[#303030] text-sm">
              Artikel yang Anda buat berhasil diposting.
            </p>
          </div>
...
export default SuccessSendArticle;